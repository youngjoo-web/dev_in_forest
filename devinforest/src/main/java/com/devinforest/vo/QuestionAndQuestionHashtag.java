...
public class QuestionAndQuestionHashtag {
	...
	public String toString() {
		return "QuestionAndQuestionHashtag [questionNo=" + questionNo + ", memberName=" + memberName
				+ ", questionTitle=" + questionTitle + ", questionContent=" + questionContent + ", questionReputation="
				+ questionReputation + ", questionCreateDate=" + questionCreateDate + ", questionUpdateDate="
				+ questionUpdateDate + ", questionViews=" + questionViews + ", questionNumOfAnswers="
				+ questionNumOfAnswers + ", questionNumOfVotes=" + questionNumOfVotes + ", questionIp=" + questionIp
